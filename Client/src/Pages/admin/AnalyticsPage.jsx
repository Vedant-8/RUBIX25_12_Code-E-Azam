...
const AnalyticsPage = () => {
  ...
  const monthlyStats = {
    co2_reduction: {
      ...
      data: [1000, 1200, 1100, 900, 950, 1000, 1100, 1150, 1050, 1200, 1300, 1400], // Replace with real data
    },
    water_saved: {
      labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
      data: [2000, 2500, 2400, 2200, 2300, 2500, 2700, 2800, 2600, 2700, 2900, 3000], // Replace with real data
    },
    trees_planted: {
      labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
  ...
  const revenueData = {
    ...
    datasets: [
      {
        label: "Revenue ($)",
        data: [5000, 6000, 7000, 8000, 7500, 8500, 9000, 9500, 10000, 11000, 12000, 13000], // Replace with real data
  ...
  return (
    <>
      ...
      <div className="p-8 bg-gray-50">
        ...
        {/* Graphs Section Below Leaderboard */}
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Left Section for Graphs */}
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-6">Impact Generation (Month Wise)</h3>
            
            {/* CO2 Reduction Graph */}
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-gray-700 mb-2">CO2 Reduction (kg)</h4>
              <Line
                data={{
            ...
            {/* Water Saved Graph */}
            <div>
              <h4 className="text-lg font-semibold text-gray-700 mb-2">Water Saved (liters)</h4>
              <Line
                data={{
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            {/* Trees Planted Graph */}
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-gray-700 mb-2">Trees Planted</h4>
              <Line
                data={{
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-700 mb-2">Revenue Generation</h4>
